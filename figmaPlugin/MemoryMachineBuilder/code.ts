...
figma.ui.onmessage = async (msg) => {
  // Generic function to generate slides from a payload
  const generateSlides = async (payload: any) => {
    // ... existing generation logic will be moved here ...
  };
  ...
  } else if (msg.type === 'generate-plan') {
    // This is a new message type for our plan
    const payload = msg.payload;
    await generateSlides(payload); // We can reuse the same generation logic
