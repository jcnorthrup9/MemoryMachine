...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # repo root (this file lives one level down, in blender/)
...
remixed_dir = os.path.join(BASE_DIR, "archive", "diagrams", "remixed_svgs")
...
try:
    ...
    if response.status_code == 200:
        with open(os.path.join(BASE_DIR, "blender_handoff.json"), "w") as f:
